...
public class DoubleFilingCabinetMenu extends AbstractContainerMenu {

    public final DoubleFilingCabinetBlockEntity blockEntity;
    ...
    public DoubleFilingCabinetMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public DoubleFilingCabinetMenu(int containerId, Inventory inv, BlockEntity blockEntity) {
        super(RFRMenuTypes.DOUBLE_FILING_CABINET_MENU.get(), containerId);
        this.blockEntity = (DoubleFilingCabinetBlockEntity) blockEntity;
    ...
    private static class CabinetSlot extends Slot {
        private final DoubleFilingCabinetBlockEntity be;
        private final int index;

        public CabinetSlot(DoubleFilingCabinetBlockEntity be, int index, int x, int y) {
